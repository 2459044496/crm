			...
			<section class="panel">
				...
				<div class="panel-body">
					<form class="form-horizontal adminex-form" id="resume-form"
						...
						action="${pageContext.request.contextPath}/sys/role/doxg?rid=${rid}">
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label"><span>*</span>角色名称</label>
							<div class="col-sm-10">
								<input name="role_Name" type="text" id="role_Name"
									class="form-control" value="${r.role_Name}"> <font color="red"></font>
							</div>
						</div>
						<div class="form-group">
...
<script src="${pageContext.request.contextPath }/statics/js/roleadd.js"></script>
