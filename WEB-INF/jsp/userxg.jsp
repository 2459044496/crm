			...
			<section class="panel">
				...
				<div class="panel-body">
					<form class="form-horizontal adminex-form" id="resume-form"
						...
						action="${pageContext.request.contextPath}/sys/user/doxg?urid=${urid}">
						<div class="form-group" id="ceshizhanghao">
							<label class="col-sm-2 col-sm-2 control-label"><span>*</span>员工账号</label>
							<div class="col-sm-8">
								<input name="ucode" type="text" id="ucode" value="${u.ucode}"
									class="form-control" readonly="readonly"> <font
									color="red"></font>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="uname" type="text" class="form-control"
									value="${u.uname}" placeholder="请输入员工姓名">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="upwd" type="text" class="form-control"
									placeholder="请输入密码" value="${u.upwd}">
							</div>
							<div class="col-sm-2"></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="urole" class="form-control" id="urole">
									<option value="${u.urole}">${u.role.role_Name}</option>
						...
						<c:if test="${u.sex == 1}">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<label class="radio-inline"> <input name="sex"
										value="1" type="radio" checked="checked"> 男 </label> <label
...
<script src="${pageContext.request.contextPath }/statics/js/userxg.js"></script>
